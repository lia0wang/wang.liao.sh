...
export function Standard(): JSX.Element {
	...
	useEffectOnce(() => {
		...
		const program = new Program(gl, {
			// if light mode is enabled, use the light vertex shader
			// otherwise use the dark vertex shader
			vertex: VertexShader,
		...
		function update(t: number): void {
			...
			particles.rotation.z += 0.0050;
			program.uniforms.uTime.value = t * 0.00050;
